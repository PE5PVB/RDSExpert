...
- Added Slow Labelling Codes (SLC) indicators to the Groups Monitor. This information is sent to group 1A and indicates, for example, the presence of an indicator of an Extended Country Code.
